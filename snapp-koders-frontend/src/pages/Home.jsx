...
const features = [
  ...
  },
  {
    ...
    description:
      'Get personalized suggestions to save better and grow smarter.',
    image: Feature2,
    color: '#e8f5e9',
  },
  {
...
const Home = () => {
  ...
  const handleFeatureClick = (index) => {
    if (features[index].title === 'Smart Financial Tips') {
      ...
      >
        ...
        >
          ...
          >
            ...
            <br></br>and an AI assistant at your fingertips.
          </Typography>
        </Box>
        <Box flex={1}>
            ...
            <Grid item xs={12} sm={4} key={index}>
              <Card
                sx={{
                  ...
                  cursor:
                    feature.title === 'Smart Financial Tips'
                      ? 'pointer'
                      : 'default',
                  '&:hover':
                    feature.title === 'Smart Financial Tips'
                  ...
                  <Box display="flex" justifyContent="center" mb={3}>
                    <Box
                      sx={{
                        ...
                        borderRadius: '50%',
                        background:
                          'linear-gradient(135deg, #ffffff88, #ffffff22)',
                        display: 'flex',
                        alignItems: 'center',
